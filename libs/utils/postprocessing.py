...
def postprocess_results(results, cls_score_file, num_pred=200, topk=2):
    ...
    for vid, result in results.items():
        ...
        # print("curr_cls_scores: ", curr_cls_scores)
        # print("topk_cls_idx: ", topk_cls_idx)
        # print("topk_cls_score: ", topk_cls_score)
        ...
        # print("new_pred_score: ", new_pred_score)
        # print("new_pred_segment: ", new_pred_segment)
        # print("new_pred_label: ", new_pred_label)
        # exit(1)
